...
public class Estudiantes {
    ...
    @objid ("6013498c-5c38-4de4-83e4-052e5764c0ae")
    public Estudiantes(final String nombre, final String identificador) {
        this.nombre = nombre;
    ...
    public String toString() {
        return String.format("\n nombre: %s, identificador: %s", nombre, identificador);
    }
