...
public class Cpifp {
    ...
    @objid ("8752baab-a4cb-4303-9481-3bf374f4bc4c")
    ...
    public List<Estudiantes> getListaEstudiantes() {
        System.out.println("Lista de estudiantes del centro:");
        return listaEstudiantes;
    }

    @objid ("764ed6f0-a553-4d80-a60c-d42150f94fd1")
    public List<Departamentos> getListaDepartamentos() {
        System.out.println("Lista de departamentos del centro:");
    ...
    public String toString() {
        return String.format("Datos del Cpifp: [ nombre: %s, direccion: %s, telefono: %s ]", nombre, direccion, telefono);
    }
